...
pip install langdetect langchain langchain-community sentence-transformers faiss-cpu fire nltk mauve-text evaluation torchmetrics gradio cmake packaging
